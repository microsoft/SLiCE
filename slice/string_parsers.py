...
def parse_entity_names(
    entity_string: str, delimiters: List[str] = [",", ";"]
) -> Set[str]:
    """
...
def remove_special_characters(
    string: str, chars_to_remove: List[str], replace_char: Optional[str] = "_"
) -> str:
    """
    ...
    result = pattern.sub(replace_char or "", string)
...
def clean_entity(
    ...
    if chars_to_remove is not None:
        cleaned = remove_special_characters(
            entity_string, chars_to_remove, replace_char
        )
        return cleaned
