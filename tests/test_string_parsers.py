...
from slice.string_parsers import (
    clean_entity,
    parse_entity_names,
...
class TestRemoveSpecialCharacters:
    ...
    def test_basic_removal(self):
        ...
        result = remove_special_characters(
            """MODULE @"/shares/IDEAs.Prod.Data/Publish.Profiles.Tenant.Commercial.IDEAsTenantProfile/Resources/v4/IDEAsTenantProfileExtension_v2.module" AS IDEAsTenantProfileExtension""",
            ["@", '"', " "],
        )
        assert (
            result
            == "MODULE_/shares/IDEAs.Prod.Data/Publish.Profiles.Tenant.Commercial.IDEAsTenantProfile/Resources/v4/IDEAsTenantProfileExtension_v2.module_AS_IDEAsTenantProfileExtension"
        )
    ...
    def test_multiple_occurrences(self):
        ...
        result = remove_special_characters(
            "test!!string@@test", ["!", "@"], replace_char="_"
        )
